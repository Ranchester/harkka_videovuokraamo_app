...
public class AddRentView extends JPanel {

  private static void AddRentView() {
  ...
  JLabel AddDVDLabel = new JLabel("Lisää vuokraustieto");
  ...
  JLabel AsiakasNro = new JLabel("Asiakasnumero");
  c.fill = GridBagConstraints.HORIZONTAL;
  c.insets = new Insets(10,0,0,0); 
  c.gridx = 0;
  c.gridy = 4;
  ...
  JLabel VuokrausPv = new JLabel("Vuokrauspäiva");
  c.fill = GridBagConstraints.HORIZONTAL;
  c.insets = new Insets(10,0,0,0); 
  c.gridx = 0;
  c.gridy = 6;
  ...
  JLabel PalautusPv = new JLabel("Palautuspäivä");
  c.fill = GridBagConstraints.HORIZONTAL;
  c.insets = new Insets(10,0,0,0); 
  c.gridx = 0;
  c.gridy = 8;
  ...
  JButton Paluu = new JButton("Paluu");
